...
namespace AthodBeTrackApi.Controllers
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        public RoleController(IRoleService roleService, ILogger<RoleController> logger, IJWTManagerService jWTManager)
        {
        ...
        public async Task<IActionResult> GetAsync(int id)
        {
            ...
            var res = new ResponseModel<RoleModel>();
            var role = await _roleService.GetByIdAsync(id);
            if (role == null)
            {
                msg.status = Message.error;
                msg.message = $"Role with id: { id} not found.";
                return Ok(msg);
            }
            res.status = Message.success;
            res.data = role;
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] RoleModel request)
        {
            try
            {
                #region Token Validation
                ...
                if (result)
                {
                    ...
                    msg.message = "Role added successfully.";
                }
                else
                {
                    msg.status = Message.error;
                    msg.message = "Role adding failed.";
                }
                return Ok(msg);
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] RoleModel request)
        {
            try
            {
                #region Token Validation
                ...
                {
                    msg.status = Message.error;
                    msg.message = "Role updation failed.";
                }
                return Ok(msg);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                msg.status = Message.success;
                msg.message = $"Role with id: { id} deleted.";
                return Ok(msg);
            }
            catch (Exception ex)
            {
