...
namespace AthodBeTrackApi.Controllers.Master
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        public CategoryController(ICategoryService service, ILogger<CategoryController> logger, IJWTManagerService jWTManager)
        {
            _service = service;
            _logger = logger;
        ...
        {
            var res = new ResponseModel<List<CategoryModel>>();
            try
            {
        ...
        public async Task<IActionResult> GetAsync(int id)
        {
            ...
            {
                msg.status = Message.error;
                msg.message = $"Category with Id: { id} not found.";
                return Ok(msg);
            }
            res.status = Message.success;
            res.data = category;
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] CategoryModel request)
        {
            try
            {
                #region Token Validation
                ...
                {
                    msg.status = Message.error;
                    msg.message = "Category adding failed";
                }
                return Ok(msg);
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] CategoryModel request)
        {
            try
            {
                #region Token Validation
                ...
                {
                    msg.status = Message.error;
                    msg.message = "Category updation failed";
                }
                return Ok(msg);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                msg.status = Message.success;
                msg.message = $"Category with Id: { id} deleted";
                return Ok(msg);
            }
            catch (Exception ex)
            {
